  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="orb animate-float h-[420px] w-[420px] bg-[#5eead4]/60" style={{ top: "-8%", left: "-6%" }} />
        <div className="orb animate-float h-[480px] w-[480px] bg-[#93c5fd]/60" style={{ bottom: "-12%", right: "-8%", animationDelay: "4s" }} />
        <div className="orb animate-pulse-soft h-[300px] w-[300px] bg-[#c4b5fd]/50" style={{ top: "40%", left: "35%" }} />
      </div>
      ...
      <div className="relative z-10 flex min-w-0 flex-1 flex-col">
        ...
        <footer className="mt-auto border-t border-slate-900/10 bg-white/40 px-4 py-4 backdrop-blur-md sm:px-6 lg:px-8">
          <div className="mx-auto flex max-w-[1500px] flex-col items-center justify-between gap-2 text-[11px] text-slate-600 sm:flex-row">
            ...
            <div className="flex items-center gap-3">
              <span className="rounded border border-amber-500/40 bg-amber-500/15 px-1.5 py-0.5 text-[10px] text-amber-700">
